...
export default function ShopPage() {
  useSEO({
    title: "Shop Solar & Backup Power Packages",
    description:
      "Browse SYO Energy Solutions' hybrid solar systems, Deye and Growatt inverters, LiFePO4 battery banks and backup power packages, priced for Lagos homes and businesses.",
    path: "/shop",
  });
