...
export default function Home() {
  useSEO({
    title: "Solar & Backup Power Installation in Lagos",
    description:
      "SYO Energy Solutions designs and installs hybrid solar systems, backup power and inverter solutions for homes, businesses and developers across Lagos. Get a free site assessment.",
    path: "/",
  });
